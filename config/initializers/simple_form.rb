...
SimpleForm.setup do |config|
  ...
  config.wrappers :default, class: :field,
    hint_class: nil, error_class: nil, valid_class: nil do |b|
    ...
    ## Inputs
    b.use :label, error_class: 'has-text-danger'
    b.use :input, class: 'input', wrap_with: { tag: :div, class: :control }, error_class: 'is-danger'
    b.use :hint,  wrap_with: { tag: :p, class: 'help is-success' }
  ...
  config.collection_wrapper_class = :select
